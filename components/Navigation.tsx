  ...
  return (
    <>
              ...
              return (
                ...
                >
                  ...
                  <Button
                    ...
                    className={`relative w-full justify-start rounded-2xl h-12 transition-all
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
        ...
        <div className="glass rounded-3xl border border-slate-200 bg-white/90 backdrop-blur-xl shadow-2xl">
          ...
          <div className="flex h-18 items-center justify-around px-2 py-2">
                ...
                >
                  ...
                  >
                    ...
                    {isCurrent && (
                      ...
                      <motion.div
                        layoutId="mobile-nav"
                        className="absolute inset-0 mx-auto h-14 w-16 rounded-2xl bg-cyan-600"
                        transition={{
                          type: 'spring',
                          stiffness: 350,
                          damping: 28,
                    ...
                    <div className="relative z-10 flex h-14 w-16 flex-col items-center justify-center">
            ...
            >
              ...
              <motion.div
                whileTap={{ scale: .92 }}
                className="flex h-14 w-16 flex-col items-center justify-center rounded-2xl text-slate-500 transition hover:bg-slate-100"
              >
