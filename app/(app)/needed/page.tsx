  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`${products.length} product${products.length !== 1 ? 's' : ''} waiting to be ordered`}
        icon={Package}
        search={search}
      ...
      <ProductGrid
        ...
        emptyDescription={
          search ? 'No products match your search.' : 'Add a product when something needs to be purchased.'
        }
        emptyAction={{ label: 'Add Product', onClick: () => setFormOpen(true) }}
